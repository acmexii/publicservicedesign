                ...
                <v-table>
                    ...
                    <tbody>
                        <tr v-for="(val, idx) in value" :key="val" @click="changeSelectedRow(val)" :style="val === selectedRow ? 'background-color: #f0f3ff;':''">
                            ...
                            <td class="whitespace-nowrap" label="민원내용">{{ val.민원내용 }}</td>
                            <td class="whitespace-nowrap" label="진행상태">{{ val.진행상태 }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="민원내용" v-model="selectedRow.민원내용" :editMode="true"/>
                            <String label="진행상태" v-model="selectedRow.진행상태" :editMode="true"/>
