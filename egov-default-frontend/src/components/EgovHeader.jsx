        ...
        <div className="header">
            <div className="inner">
                ...
                <div className="gnb">
                    ...
                    <li><NavLink to="/process2/minwonType2s" className={({ isActive }) => (isActive ? "cur" : "")}>민원유형2</NavLink></li>


                    <li><NavLink to="/compensation/rewardApplications" className={({ isActive }) => (isActive ? "cur" : "")}>보상신청심의</NavLink></li>

                    <li><NavLink to="/compensation/compensationPayments" className={({ isActive }) => (isActive ? "cur" : "")}>보상지급</NavLink></li>


                    <li><NavLink to="/analysis1/analysis1s" className={({ isActive }) => (isActive ? "cur" : "")}>분석관점1</NavLink></li>


                    <li><NavLink to="/analysis2/analysis2s" className={({ isActive }) => (isActive ? "cur" : "")}>분석관점</NavLink></li>
