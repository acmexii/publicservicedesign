...
import MinwonType2List from 'pages/process2/MinwonType2List';
import MinwonType2Detail from 'pages/process2/MinwonType2Detail';
import MinwonType2Edit from 'pages/process2/MinwonType2Edit';
import RewardApplicationList from 'pages/compensation/RewardApplicationList';
import RewardApplicationDetail from 'pages/compensation/RewardApplicationDetail';
import RewardApplicationEdit from 'pages/compensation/RewardApplicationEdit';
import CompensationPaymentList from 'pages/compensation/CompensationPaymentList';
import CompensationPaymentDetail from 'pages/compensation/CompensationPaymentDetail';
import CompensationPaymentEdit from 'pages/compensation/CompensationPaymentEdit';
...
import Analysis2List from 'pages/analysis2/Analysis2List';
import Analysis2Detail from 'pages/analysis2/Analysis2Detail';
import Analysis2Edit from 'pages/analysis2/Analysis2Edit';
  ...
  return (
    <>
      ...
      <Routes>
          ...
          <Route path="/process2/minwonType2s" element={<MinwonType2List />} />
          <Route path="/process2/MinwonType2Edit" element={<MinwonType2Edit />} />
          <Route path="/process2/MinwonType2Detail" element={<MinwonType2Detail />} />

          <Route path="/compensation/rewardApplications" element={<RewardApplicationList />} />
          <Route path="/compensation/RewardApplicationEdit" element={<RewardApplicationEdit />} />
          <Route path="/compensation/RewardApplicationDetail" element={<RewardApplicationDetail />} />

          <Route path="/compensation/compensationPayments" element={<CompensationPaymentList />} />
          <Route path="/compensation/CompensationPaymentEdit" element={<CompensationPaymentEdit />} />
          <Route path="/compensation/CompensationPaymentDetail" element={<CompensationPaymentDetail />} />
          ...
          <Route path="/analysis2/analysis2s" element={<Analysis2List />} />
          <Route path="/analysis2/Analysis2Edit" element={<Analysis2Edit />} />
          <Route path="/analysis2/Analysis2Detail" element={<Analysis2Detail />} />
