...
function EgovNoticeEdit(props) {
    ...
    const updateBoard = () => {
        ...
        const entity = {
            id: boardDetail.id,
            reason: boardDetail.reason
        };

        axios.post('/rewardApplications', entity)
        .then(response => {
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="board_view2">
                            ...
                            <dl>
                                <dt>
                                    <label htmlFor="nttSj">사유</label>
                                </dt>
                                <dd>
                                    <input className="f_input2 w_full" id="reason" name="reason" type="text"
                                        onChange={e => setBoardDetail({ ...boardDetail, reason: e.target.value })}
                                        maxLength="60" />
                                </dd>
                            </dl>
                            {/* <!-- 버튼영역 --> */}
                            <div className="board_btn_area">
                                ...
                                <div className="right_col btn1">
                                    <Link to="/compensation/rewardApplications" className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
