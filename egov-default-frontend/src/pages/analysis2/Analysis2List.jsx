...
function EgovNoticeList(props) {
    ...
    const retrieveList = useCallback((searchCondition) => {
        ...
        const retrieveListURL = '/analysis2s'+EgovNet.getQueryString(searchCondition);;
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                // 리스트 항목 구성
                resp._embedded.analysis2s.forEach(function (item, index) {
                    if (index === 0) mutListTag = []; // 목록 초기화
                    const listIdx = itemIdxByPage(resultCnt , currentPageNo, pageSize, index);

                    mutListTag.push(
                        <Link
                            to={{pathname: "/analysis2/Analysis2Detail"}}
                            state={{
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="top_tit">
                            <h1 className="tit_1">민원분석2</h1>
                        </div>

                        <h2 className="tit_2">분석관점</h2>
                        ...
                        <div className="condition">
                            <ul>
                                ...
                                <li className="third_2 R">
                                    ...
                                    <li>
                                        <Link to="/analysis2/Analysis2Edit" state={{bbsId: bbsId}} className="btn btn_blue_h46 pd35">등록</Link>
                                    </li>
                            </ul>
                        </div>
                        {/* <!--// 검색조건 --> */}
