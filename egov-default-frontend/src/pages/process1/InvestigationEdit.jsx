...
function EgovNoticeEdit(props) {
    ...
    const updateBoard = () => {
        ...
        const entity = {
            ...
            민원번호: boardDetail.민원번호
        };

        axios.post('/investigations', entity)
        .then(response => {
        ...
        return (
            <div className="location">
                <ul>
                    ...
                    <li><Link to="/process1/investigations">Investigation</Link></li>
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="top_tit">
                            <h1 className="tit_1">Investigation</h1>
                        </div>
                        ...
                        <div className="board_view2">
                            ...
                            <dl>
                                <dt>
                                    <label htmlFor="nttSj">설명</label>
                                </dt>
                                <dd>
                                    <input className="f_input2 w_full" id="description" name="description" type="text"
                            ...
                            <dl>
                                <dt>
                                    <label htmlFor="nttSj">민원번호</label>
                                </dt>
                                <dd>
                                    <input className="f_input2 w_full" id="민원번호" name="민원번호" type="text"
                                        onChange={e => setBoardDetail({ ...boardDetail, 민원번호: e.target.value })}
                                        maxLength="60" />
                                </dd>
                            </dl>
                            {/* <!-- 버튼영역 --> */}
                            <div className="board_btn_area">
                                ...
                                <div className="right_col btn1">
                                    <Link to="/process1/investigations" className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
