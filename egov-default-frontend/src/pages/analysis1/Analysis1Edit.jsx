...
function EgovNoticeEdit(props) {
    ...
    const updateBoard = () => {
        ...
        axios.post('/analysis1s', entity)
        .then(response => {
            const resp = response.data;
            if (resp._links.self.href.split('/').pop()) {
                navigate('/analysis1/analysis1s');
            } else {
        ...
        return (
            <div className="location">
                <ul>
                    ...
                    <li><Link to="/analysis1/analysis1s">Analysis1</Link></li>
                ...
                <div className="layout">
                    ...
                    <div className="contents NOTICE_LIST" id="contents">
                        ...
                        <div className="top_tit">
                            <h1 className="tit_1">Analysis1</h1>
                        </div>
                        ...
                        <div className="board_view2">
                            ...
                            <div className="board_btn_area">
                                ...
                                <div className="right_col btn1">
                                    <Link to="/analysis1/analysis1s" className="btn btn_blue_h46 w_100">목록</Link>
                                </div>
                            </div>
                            {/* <!--// 버튼영역 --> */}
                        </div>
