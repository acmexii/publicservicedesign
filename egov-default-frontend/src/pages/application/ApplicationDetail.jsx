...
function EgovNoticeDetail(props) {
    ...
    const 민원번호 = location.state.민원번호;
    ...
    const retrieveDetail = () => {
        const retrieveDetailURL = `/applications/${민원번호}`;
    ...
    function deleteList(){
        axios.delete(`/applications/${민원번호}`)
            ...
            <div className="c_wrap">
                ...
                <div className="location">
                    <ul>
                        ...
                        <li><Link to="/application/applications">Application</Link></li>
                        ...
                        <div className="board_view">
                            <div className="board_view_top">
                                ...
                                <div className="info">
                                    ...
                                    <dl>
                                        <dt>민원내용</dt>
                                        <dd>{boardDetail && boardDetail.민원내용 }</dd>
                                    </dl>
                                    <dl>
                                        <dt>진행상태</dt>
                                        <dd>{boardDetail && boardDetail.진행상태 }</dd>
                                    </dl>
                                </div>
                            </div>
                            <div className="board_btn_area">
                                ...
                                <div className="right_col btn1" style={{marginTop: "5px"}}>
                                    <Link to="/application/applications"
